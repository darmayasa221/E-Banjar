      ...
      <div class="right-side">
        <div class="right-side-conten ">
          <div class="search_content">
            ...
            <div class="p-2">
              <button class=" p-2 duration-300 bg-blue-500 hover:bg-green-500 rounded-md text-white text-m">Tambah Kegiatan</button>
            </div>
          </div>
        <div class="right-side-conten">
            ...
            <table class="shadow-2xl w-full rounded overflow-hidden" >
              <thead class="text-center bg-blue-500 flex text-white w-full">
                <tr class="flex w-full mb-4">
                  ...
                  <th class="p-4 w-1/2">Deskripsi</th>
                  <th class="mr-5 p-4 w-1/7">Edit/Delete</th>
                </tr>
              </thead>
              <tbody class=" border border-fuchsia-600 text-left flex flex-col items-center justify-between overflow-y-scroll w-full">
                <tr class="border-b-2 border-fuchsia-600 flex w-full">
                  <td class=" flex justify-center p-4 text-center border-r-2 border-fuchsia-600 w-1/6">
                    <img src="http://placehold.it/100x100" alt="activity img">
                  </td>
                  <td class=" p-4 text-center border-r-2 border-fuchsia-600 w-1/4">about</td>
                  ...
                  <td class=" p-4 text-center w-1/7">
