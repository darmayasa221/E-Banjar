  ...
  <div class="max-w-md w-full- mx-auto text-3xl font-bold">E-Banjar</div>
    <div class="shadow-2xl max-w-md w-full mx-auto mt-4 bg-white p-8 border border-gray-300">
      <form>
        ...
        <div class="mt-3">
          <button class="p-2 btn_rgs btn_register duration-500 w-full py-2 px-4 bg-blue-500 hover:bg-green-500 rounded-md text-white text-m" type="submit" name="login">Login</button>
        </div>
        <div class="mt-3">
         <a class="text-sm font-black text-gray-600 block text-center" href="../../index.php" >return to first pages?</a>
        </div>
      </form>
    </div>
  </div>
