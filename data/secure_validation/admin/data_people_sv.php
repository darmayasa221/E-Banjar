      ...
      <div class="right-side">
        <div class="right-side-conten ">
          <div class="search_content">
            ...
            <div class="p-2">
              <button class=" p-2 duration-300 bg-blue-500 hover:bg-green-500 rounded-md text-white text-m">Tambah Maasyarakat</button>
            </div>
          </div>
        <div class="right-side-conten">
            ...
            <table class="shadow-2xl w-full rounded overflow-hidden" >
              <thead class="text-center bg-blue-500 flex text-white w-full">
                <tr class="flex w-full mb-4">
                  ...
                  <th class="p-4 w-1/6">Passowrd</th>
                  <th class="p-4 w-1/6">No HP</th>
                  <th class="p-4 w-1/4">NIK</th>
                  <th class="p-4 w-1/2">Alamat</th>
                  <th class="mr-2 p-4 w-1/7">Edit/Delete</th>
                </tr>
              </thead>
              <tbody class=" border border-fuchsia-600 text-left flex flex-col items-center justify-between overflow-y-scroll w-full">
                <tr class="border-b-2 border-fuchsia-600 flex w-full">
                  <td class=" p-4 text-center border-r-2 border-fuchsia-600 w-1/4">Your Name</td>
                  <td class=" p-4 text-center border-r-2 border-fuchsia-600 w-1/6">12731sw</td>
                  <td class=" p-4 text-center border-r-2 border-fuchsia-600 w-1/6">08511111111</td>
                  <td class=" p-4 text-center border-r-2 border-fuchsia-600 w-1/4">111111111111111</td>
                  <td class=" border-r-2 border-fuchsia-600 w-1/2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repellendus, deserunt. Quidem quas culpa similique nobis officia laboriosam voluptatibus reiciendis veniam eveniet obcaecati, libero commodi possimus, rem ut, est consequuntur porro!</td>
                  <td class=" p-4 text-center border-r-2 border-fuchsia-600 w-1/7">
                  <div class="flex flex-col items-center justify-center h-full">
                    <button class=" m-2 w-full duration-300 bg-blue-500 hover:bg-green-500 rounded-md text-white text-m">Edit</button>
                    <button class=" m-2 w-full duration-300 bg-blue-500 hover:bg-red-500 rounded-md text-white text-m">Delete</button>
                  </div>
                  </td>
                </tr>
              </tbody>
