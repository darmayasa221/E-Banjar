        ...
        <div class="right-side-conten ">
          <form class="about_profile">
            <div class="flex justify-center mb-10">
              <img class="shadow-2xl" src="http://placehold.it/500x250" alt="profile">
            </div>
            <div class="about_form">
              ...
              <div class="detail_profile">
                ...
                <textarea class="p-2 border border-gray-300 rounded mt-1 duration-300 hover:shadow-xl transform hover:-translate-y-1 focus:-translate-y-1" name="comment" id="comment" placeholder="Comment Here"></textarea>
              </div>
            </div>
            <div class="mt-3">
