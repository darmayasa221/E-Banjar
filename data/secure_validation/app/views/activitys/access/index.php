          ...
          <tr class="<?= $key ?> border-b-2 border-fuchsia-600 flex w-full">
            ...
            <td class=" p-4 text-center w-1/8">
              <div class="flex flex-col items-center justify-center h-full">
                <button class=" m-2 w-full duration-300 bg-blue-500 hover:bg-green-500 rounded-md text-white text-m" onclick="location.href='<?= BASEURL ?>/activitys/adminFormActivity/<?= $value['nama_kegiatan'] ?>/<?= $value['id'] ?>';">Edit</button>
